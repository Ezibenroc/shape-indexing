...
double getPerimeter(const Domain domain, const DigitalSet object, vector<Point> &border) {
...
double perimeterVSarea(const Domain domain, const DigitalSet object, vector<Point> &border) {
